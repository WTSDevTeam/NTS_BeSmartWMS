namespace mBudget.DatabaseForms
{
    partial class frmUM
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.lblCode.Text = "รหัสหน่วยนับ :";
            ...
            this.Text = "ฐานข้อมูลหน่วยนับ";
            this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmUM_KeyDown);
