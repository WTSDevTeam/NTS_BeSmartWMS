...
namespace mBudget.Business.Agents
{
    ...
    public class ConfigurationAgent
    {
        ...
        private mBudget.Business.Entity.Info.ConnectionInfo mConnInfo = null;
        ...
        {
            this.mConnInfo = new mBudget.Business.Entity.Info.ConnectionInfo();
            this.pmLoadConfigSchemaTab();
        }

        public mBudget.Business.Entity.Info.ConnectionInfo ConnectionInfo
        {
        ...
        public bool TestConnect(string inServerName, string inDBName, WS.Data.DBMSType inDBReside)
        {
            ...
            //return this.pmTestConnect(strConnStr, inDBReside, "MASTER_DEPT");
        }
