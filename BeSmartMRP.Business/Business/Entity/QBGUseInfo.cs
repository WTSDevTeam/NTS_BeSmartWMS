...
namespace BeSmartMRP.Business.Entity
{
    ...
    public class QBGUseInfo
    {

        public static string TableName = MapTable.Table.BudUseHD;
        public static string TableNameItem1 = MapTable.Table.BudUseIT;
        ...
        public struct Field
        {
            ...
            public static string BGRecvHD = "CBGRECVHD";
