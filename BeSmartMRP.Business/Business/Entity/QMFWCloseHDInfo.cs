...
namespace BeSmartMRP.Business.Entity
{
    ...
    public class QMFWCloseHDInfo
    {
    
        public static string TableName = MapTable.Table.MFWCloseHead;
        ...
        public struct Field
        {
            ...
            public static string CostDL = "NCOSTDL";
            public static string CostOH = "NCOSTOH";
            public static string CostAdj1 = "NCOSTADJ1";
            public static string CostAdj2 = "NCOSTADJ2";
            public static string CostAdj3 = "NCOSTADJ3";
            public static string CostAdj4 = "NCOSTADJ4";
            public static string CostAdj5 = "NCOSTADJ5";
