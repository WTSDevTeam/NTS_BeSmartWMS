...
namespace BeSmartSysncDataIm
{
    ...
    public partial class wsSyncDBDataImport : ServiceBase
    {
        ...
        public wsSyncDBDataImport()
        {

            this.AutoLog = true;
            this.ServiceName = "BeSmart SyncData Import Service";
        ...
        protected override void OnStart(string[] args)
        {
            ...
            this.WriteAppLog("Start Load Import Config [Start]");
            ...
            if (System.IO.File.Exists(App.FileConfig))
            {
                ...
                {
                    this.WriteAppLog("OnStart : " + ex.Message);
                }
                finally
                {
            ...
            {
                EventLog evt = new EventLog("BeSmart SyncData Import Service");
                evt.Source = "BeSmart SyncData Import Service";
